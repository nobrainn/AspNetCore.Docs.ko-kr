...
- <xref:performance/blazor/webassembly-best-practices>-Blazor WASM 성능 모범 사례 문서를 추가 합니다.

## <a name="security"></a>보안

### <a name="new-articles"></a>새 문서

- <xref:security/blazor/server/additional-scenarios>-Blazor 서버 보안 노드 만들기
- <xref:security/blazor/server/index>-Blazor 서버 보안 노드 만들기
- <xref:security/blazor/webassembly/aad-groups-roles>-AAD 그룹 및 역할을 사용 하는 Blazor WASM
...
- <xref:security/blazor/webassembly/hosted-with-identity-server>-Id 서버가 있는 Blazor에 대 한 이름 및 역할 클레임 구성 섹션 추가
