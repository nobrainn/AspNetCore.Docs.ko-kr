...
이 샘플에서는 [사용자가 이전 페이지에서](xref:security/authentication/social/index)만든 ASP.NET Core 3.0 프로젝트를 사용하여 사용자 자신의 업무, 학교 또는 개인 Microsoft 계정으로 로그인할 수 있도록 하는 방법을 보여 주었습니다.
