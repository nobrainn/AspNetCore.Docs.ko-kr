...
[AAD 테 넌 트 및 웹 응용 프로그램 만들기](/azure/active-directory/develop/v2-overview)

Azure Portal의 **Azure Active Directory**  >  **앱 등록** 영역에서 AAD 앱을 등록 합니다.

1. 앱에 대 한 **이름** (예: ** Blazor 독립 실행형 AAD Microsoft 계정**)을 입력 합니다.
1. **지원 되는 계정 유형**에서 **조직 디렉터리의 계정**을 선택 합니다.
...
앱을 만듭니다. 다음 명령에서 자리 표시자를 앞에서 기록한 정보로 바꾸고 명령 셸에서 다음 명령을 실행 합니다.
...
* Microsoft 계정를 사용 하 여 앱에 로그인 합니다.
