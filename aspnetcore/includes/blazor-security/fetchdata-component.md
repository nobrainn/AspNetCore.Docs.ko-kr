<span data-ttu-id="30548-101">구성 `FetchData` 요소는 다음을 수행 하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="30548-101">The `FetchData` component shows how to:</span></span>
