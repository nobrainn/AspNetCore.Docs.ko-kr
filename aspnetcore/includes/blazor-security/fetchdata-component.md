<span data-ttu-id="69216-101">구성 `FetchData` 요소는 다음 방법을 보여 주며 다음과 같은 방법을 보여 주며 다음과 같은 방법을 보여 주며 다음과</span><span class="sxs-lookup"><span data-stu-id="69216-101">The `FetchData` component shows how to:</span></span>
