...
ASP.NET Core 3.1에는 `Component` 태그 도우미가 도입 되었습니다. 태그 도우미는 `RenderComponentAsync<TComponent>` 프로젝트의 HTML 도우미 메서드를 바꿀 수 있습니다 Blazor . 다음은 그 예입니다.
...
자세한 내용은 [구성 요소를 Razor Pages 및 MVC 앱에 통합](/aspnet/core/blazor/components/integrate-components-into-razor-pages-and-mvc-apps?view=aspnetcore-3.1)을 참조하세요.
