...
이 리포지토리에는 [docs.microsoft.com/aspnet/core](https://docs.microsoft.com/aspnet/core)에서 호스트되는 ASP.NET Core 문서의 개념 설명서가 포함되어 있습니다. 이 설명서에 참여하려면 [참여 가이드](CONTRIBUTING.md) 및 [문제 목록](https://github.com/dotnet/AspNetCore.Docs/issues)을 참조하세요.
